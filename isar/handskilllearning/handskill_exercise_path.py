...
class HandSkillExercisePathUI(QWizard):
    ...
    def setup_ui(self, Wizard):
        ...
        self.layout_2.addWidget(self.label_error_weighted_2, 7, 0, 1, 1)
        ...
        self.layout_2.addWidget(self.line_error_weighted_int, 7, 1, 1, 1)
        ...
        self.layout_2.addWidget(self.label_time_weighted_2, 7, 2, 1, 1)
        ...
        self.layout_2.addWidget(self.label_error_weighted_3, 11, 0, 1, 1)
        ...
        self.layout_2.addWidget(self.line_error_weighted_com, 11, 1, 1, 1)
        ...
        self.layout_2.addWidget(self.label_time_weighted_3, 11, 2, 1, 1)
